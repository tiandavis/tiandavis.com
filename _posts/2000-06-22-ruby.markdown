...
He saw the [Pieta] and he would later write in his diaries about releasing the image inside. I do the same thing with Ruby. Ruby is the raw material, the medium that could become great software. I don’t see eccentricities or quirks. I see the new Basecamp, Twitter and Freckle.

For over four years, as a Consultant, I’ve led a Fortune 500 development team through an agile transformation and built some of the best Ruby & JavaScript software of my life. See, work experience below. I’m a Master Rails Developer. See, [code samples].
...
But my passion is open standards and the modern web:

![Capabilities][capabilities]

My server-side experience leverages Ruby on Rails. I use RSpec for unit tests and FactoryGirl for mocking. I also use Capybara and Selenium for integration tests.

My front end experience leverages HTML5, CSS3 (SCSS), Compass, Foundation, JavaScript, CoffeeScript, Require, jQuery, PhoneGap, Ember, Handlebars, Emblem and EmberScript. I leverage the ember-cli as much as possible.
